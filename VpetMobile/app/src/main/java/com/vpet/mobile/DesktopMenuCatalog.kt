...
/**
 * 菜单树对照桌面 pet.py（手机精简：去 RPG/家园；工作一键开关；档案进设置层）。
        ...
        Item(
            ...
            listOf(
                ...
                Item(
                    ...
                    listOf(
                        Item("set_size_s", "小", Status.READY),
                        Item("set_size_m", "中", Status.READY),
                        Item("set_size_l", "大", Status.READY),
                        Item("set_font_s", "字·小", Status.READY),
                        Item("set_font_m", "字·中", Status.READY),
                        Item("set_font_l", "字·大", Status.READY),
                        Item("set_font_xl", "字·特大", Status.READY),
                        Item("set_sound", "音效", Status.READY),
                        Item("set_voice", "语音", Status.READY),
                        Item("set_voice_vol_down", "音量−", Status.READY),
                        Item("set_voice_vol_up", "音量+", Status.READY),
                        Item("set_diff_low", "难·低", Status.READY),
                        Item("set_diff_mid", "难·中", Status.READY),
                        Item("set_diff_high", "难·高", Status.READY),
                        Item("set_layer", "层级", Status.READY),
                        Item("tool_archive", "档案·音乐", Status.READY),
                    ),
                ),
                Item(
